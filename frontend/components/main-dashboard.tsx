...
import { Eye, EyeOff, Send, Plus, MessageCircle, Phone, FileText, Home, Newspaper, ShoppingCart, BarChart3, MoreVertical } from 'lucide-react'
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-slate-900 border-t border-slate-800">
        <div className="max-w-md mx-auto px-4 py-3 flex items-center justify-around">
          {[
            ...
            <button key={idx} className={`flex flex-col items-center gap-1 py-2 px-3 transition-colors ${item.active ? 'text-yellow-400' : 'text-slate-400 hover:text-slate-300'}`}>
